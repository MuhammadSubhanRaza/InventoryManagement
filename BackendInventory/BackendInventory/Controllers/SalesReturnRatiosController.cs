...
namespace BackendInventory.Controllers
{
    ...
    [ApiController]
    public class SalesReturnRatiosController : ControllerBase
    {
        private readonly ApplicationDbContext _context;

        public SalesReturnRatiosController(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: api/SalesReturnRatios
        [HttpGet]
        public async Task<ActionResult<IEnumerable<SalesReturnRatio>>> GetSalesReturnRatios()
        {
          if (_context.SalesReturnRatios == null)
          {
              return NotFound();
          }
        ...
        public async Task<ActionResult<SalesReturnRatio>> PostSalesReturnRatio(SalesReturnRatio salesReturnRatio)
        {
          if (_context.SalesReturnRatios == null)
          {
              return Problem("Entity set 'ApplicationDbContext.SalesReturnRatios'  is null.");
          }
        ...
        // DELETE: api/SalesReturnRatios/5
        [HttpDelete("{id}")]
        ...
        {
            return (_context.SalesReturnRatios?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
